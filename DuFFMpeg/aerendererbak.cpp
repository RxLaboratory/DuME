...
AERendererBak::AERendererBak(QObject *parent) : QObject(parent)
{
    init();
}

QList<AERenderProcess *> AERendererBak::versions() const
{
    return _versions;
}
...
void AERendererBak::setCurrentAERenderProcess( QString name )
{
...
void AERendererBak::start(QStringList arguments, QStringList audioArguments, int numThreads, bool useQueue )
{
...
void AERendererBak::launchRenderProcess(QStringList args)
{
    //create process
...
void AERendererBak::setCurrentAERenderProcess( )
{
    QSettings settings;
...
void AERendererBak::findAeVersions(QString dir)
{
...
void AERendererBak::threadFinished()
{
